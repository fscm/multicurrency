...
class TestJordanianDinar:
    ...
    def test_jordanian_dinar(self):
        ...
        assert jordanian_dinar.__hash__() == hash(
            (jordanian_dinar.__class__, decimal, 'JOD', '400'))
...
class TestKuwaitiDinar:
    ...
    def test_kuwaiti_dinar(self):
        ...
        assert kuwaiti_dinar.__hash__() == hash(
            (kuwaiti_dinar.__class__, decimal, 'KWD', '414'))
...
class TestLibyanDinar:
    ...
    def test_libyan_dinar(self):
        ...
        assert libyan_dinar.__hash__() == hash(
            (libyan_dinar.__class__, decimal, 'LYD', '434'))
...
class TestSerbianDinarXK:
    ...
    def test_serbian_dinar_xk(self):
        ...
        assert serbian_dinar_xk.__hash__() == hash(
            (serbian_dinar_xk.__class__, decimal, 'RSD', '941'))
...
class TestSerbianDinarSR:
    ...
    def test_serbian_dinar_sr(self):
        ...
        assert serbian_dinar_sr.__hash__() == hash(
            (serbian_dinar_sr.__class__, decimal, 'RSD', '941'))
...
class TestTunisianDinar:
    ...
    def test_tunisian_dinar(self):
        ...
        assert tunisian_dinar.__hash__() == hash(
            (tunisian_dinar.__class__, decimal, 'TND', '788'))
