...
`Afghani` (Af 123.456,79 | AFN 123,456.79),
...
`AzerbaijanianManat` (123.456,79 ман | AZN 123,456.79),
`BahamianDollar` ($123,456.79 | BSD 123,456.79),
`BahrainiDinar` (123,456.789 د.ب. | BHD 123,456.789),
...
`EgyptianPound` (ج.م. 123,456.79 | EGP 123,456.79),
...
`IranianRial` (123.456,79 ﷼ | IRR 123,456.79),
`IraqiDinar` (د.ع. 123.456,789 | IQD 123,456.789),
`JamaicanDollar` ($123,456.79 | JMD 123,456.79),
`JordanianDinar` (د.أ. 123,456.789 | JOD 123,456.789),
...
`KuwaitiDinar` (د.ك. 123,456.789 | KWD 123,456.789),
`Kwacha` (MK 123,456.79 | MWK 123,456.79),
`Kwanza` (123 456,79 Kz | AOA 123,456.79),
`Kyat` (123,456.79 K | MMK 123,456.79),
`Lari` (123 456,79 ლ | GEL 123,456.79),
`LebanesePound` (ل.ل. 123,457 | LBP 123,457),
`Lek` (123 456,79 Lekë | ALL 123,456.79),
...
`QatariRial` (123.456,79 ر.ق. | QAR 123,456.79),
...
`UAEDirham` (123,456.79 د.إ. | AED 123,456.79),
...
`YemeniRial` (123.456,79 ﷼ | YER 123,456.79),
