...
class Currency:
    def __new__(cls: Any, amount: Union[int, float, Decimal], alpha_code: Optional[str]=..., numeric_code: Optional[str]=..., symbol: Optional[str]=..., symbol_ahead: Optional[bool]=..., symbol_separator: Optional[str]=..., decimal_places: Optional[int]=..., decimal_sign: Optional[str]=..., grouping_sign: Optional[str]=..., international: Optional[bool]=...) -> Currency: ...
