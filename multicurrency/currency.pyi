...
class Currency:
    def __new__(cls: Any, amount: Union[int, float, Decimal], alpha_code: Optional[str]=..., numeric_code: str=..., symbol: str=..., decimal_places: int=..., decimal_sign: Optional[str]=..., grouping_sign: Optional[str]=..., international: bool=...) -> Currency: ...
